...
export function newPlant(now, prev) {
  return {
    ...
    nightlyAt: prev ? prev.nightlyAt : 0, // last background check-in (lib/nightly.js)
...
// Next time (ms) the local clock shows hour:minute, strictly after now.
export function nextAt(now, hour, minute) {
